...
object FBoundedPolymorphism extends App {
  ...
  //  Problem: How to each child return list of its type?
  // Solution 1 - naive
  ...
  //  Problem: How to each child return list of its type AND protect us from Inserting a different
  // child instead? dog for example
  // Solution 2 - FBP
...
////      override def breed: List[Animal[Dog]] = ??? // Compile error
...
//    }
  ...
  //  }
  //  //  Problem 3: How to protect by compiler to List[Animal[Crocodile]] ??
  //  class Crocodile extends Animal[Dog] {
  //    override def breed: List[Animal[Dog]] = ??? // List[Dog] !!
  //  }

  // Solution 3 - FBP + self-types - Solution of problem 3
  ...
  //  class Crocodile extends Animal[Dog] {
  //    override def breed: List[Animal[Dog]] = ??? // compiler error now
  //  }
  //
