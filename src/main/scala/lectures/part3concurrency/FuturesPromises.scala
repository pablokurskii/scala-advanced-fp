...
object FuturesPromises extends App {
  ...
  /*
    ...
    2) inSequence(fa, fb) - second furure will run after 1st is completed
    3) first(fa, fb) => new future with value of first completed future out of two
    4) last(fa, fb) => new future with the last value
    5) retryUntil[T](action: () => Future[T], condition: T => Boolean): Future[T] - run function until condition met
   */
